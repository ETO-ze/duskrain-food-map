...
- 管理端支持粘贴“编号 店名 城市或地址 评分 推荐等级”清单，一键匹配高德 POI、补全资料并批量新建。
- 推荐等级支持“必去 / 推荐 / 一般 / 避雷”；未填写时，评分不低于 8.0 默认为“推荐”，低于 8.0 默认为“一般”。
- 城市或地址不完整时使用模糊搜索，并自动采用本站匹配分最高的第一个候选；重复 POI 会跳过。
